...
# from model_gaussian import VAE
# from train_gaussain import train,test
...
def main():
    ...
    state_dict_vae = torch.load('C:/Users/heewo/Desktop/vscode_project/2022_DSAIL_Internship/VAE/checkpoints/VAE_Gaussian_decoder')
